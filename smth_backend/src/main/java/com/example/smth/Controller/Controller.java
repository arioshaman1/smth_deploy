...
@CrossOrigin(origins = "http://217.196.107.39:8081", allowedHeaders = "Content-Type, Authorization", methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE})
@RestController
